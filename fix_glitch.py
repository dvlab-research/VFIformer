...
def main():
    ...
    parser.add_argument('--img_last', default=2, type=int, help="last image index, usually first + 4")
    ...
    file_0 = basepath + "\\" + basefile + str(start).zfill(num_width) + ".png"
    file_4 = basepath + "\\" + basefile + str(end).zfill(num_width) + ".png"
    file_2 = basepath + "\\" + basefile + str(middle).zfill(num_width) + ".png"

    img0 = cv2.imread(file_0)
    img1 = cv2.imread(file_4)
    ...
    torchvision.utils.save_image(imt, file_2)
    print("saved " + file_2)

    sub_middle = int((middle + start) / 2)
    file_1 = basepath + "\\" + basefile + str(sub_middle).zfill(num_width) + ".png"

    img0 = cv2.imread(file_0)
    img1 = cv2.imread(file_2)
    ...
    imt = output[0].flip(dims=(0,)).clamp(0., 1.)
    torchvision.utils.save_image(imt, file_1)
    print("saved " + file_1)

    sub_middle = int((end + middle) / 2)
    file_3 = basepath + "\\" + basefile + str(sub_middle).zfill(num_width) + ".png"

    img0 = cv2.imread(file_2)
    img1 = cv2.imread(file_4)
    ...
    imt = output[0].flip(dims=(0,)).clamp(0., 1.)
    torchvision.utils.save_image(imt, file_3)
    print("saved " + file_3)
