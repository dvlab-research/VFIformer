...
def main():
    ...
    for n in range(start, end, step):
      ...
      file_b = basefile + str(n + offset + 1).zfill(num_width) + ".png"
      file_c = basepath + "\\" + basefile + str(n + offset + step).zfill(num_width) + ".png"
      img0 = cv2.imread(file_a)
      img1 = cv2.imread(file_c)
      ...
      torchvision.utils.save_image(imt, os.path.join(save_path, file_b))
      print("saved " + file_b)
